...
('statistics', '7-8', 3, 'A bag has 3 red, 5 blue, and 2 green marbles. What is P(blue)?', 'multiple_choice', '["1/2", "3/10", "1/5", "5/10"]', '1/2', '5 blue out of 10 total = 5/10 = 1/2', 'NC.7.SP.7', 'probability'),
...
('statistics', '8-9', 4, 'In a two-way frequency table, 30 out of 50 students who study pass the test, while 10 out of 50 who do not study pass. Is there an association?', 'multiple_choice', '["Yes, studying is associated with passing", "No association", "Cannot determine", "Only if p < 0.05"]', 'Yes, studying is associated with passing', '60% pass rate for studiers vs 20% for non-studiers shows clear association', 'NC.M1.S-ID.5', 'two_way_tables')
ON CONFLICT DO NOTHING;
