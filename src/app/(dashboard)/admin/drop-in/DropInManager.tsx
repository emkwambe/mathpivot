      ...
      <div className="bg-white border border-slate-200 rounded-xl overflow-hidden">
        ...
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-slate-100">
            ...
            {attendance.map((a: DropInAttendanceRow) => (
              <tr key={a.id}>
                ...
                <td className="px-4 py-3 text-slate-700">
                  {new Date(a.check_in_at).toLocaleTimeString("en-US", {
                    hour: "numeric",
                    minute: "2-digit",
                  })}
                </td>
                <td className="px-4 py-3 text-slate-700">
                  {a.check_out_at ? (
                    new Date(a.check_out_at).toLocaleTimeString("en-US", {
                      hour: "numeric",
                      minute: "2-digit",
                    })
                  ) : (
