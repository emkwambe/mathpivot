  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-sm text-slate-500">Bulk import students and tutors via CSV, or export data</p>
      </div>
            ...
            {jobs.map((job: unknown) => (
              <tr key={job.id}>
                ...
                <td className="px-4 py-3">
                  <span className={`inline-block px-2 py-0.5 rounded-full text-xs font-medium ${statusColors[job.status] || 'bg-slate-100'}`}>
                    {job.status}
                  </span>
                </td>
