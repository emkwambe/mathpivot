      ...
      <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-lg p-8 max-w-md w-full text-center">
          ...
          <p className="text-slate-600 mb-6">
            ...
            hours to discuss how MathPivot can help your student excel.
          </p>
          <Link
            href="/"
              ...
              {[
                {
                  ...
                  desc: "Understand exactly where your student stands",
                },
                {
                  title: "Personalized Learning Path",
                  desc: "Curriculum tailored to goals and pace",
                },
                {
                  title: "Expert Math Coaches",
                  desc: "Verified specialists in math & CS education",
                },
                {
                  title: "AI-Powered Practice",
                  desc: "Smart homework and skill-building between sessions",
                },
                {
                  title: "Progress Tracking",
                  desc: "Weekly reports with mastery-level insights",
                },
              ].map((item) => (
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {SUBJECTS.map((subj) => (
                    <label
                      key={subj}
                      className="flex items-center gap-1.5 text-xs bg-slate-50 border border-slate-200 rounded-lg px-2.5 py-1.5 cursor-pointer hover:bg-blue-50 hover:border-blue-200 has-[:checked]:bg-blue-50 has-[:checked]:border-blue-300 has-[:checked]:text-blue-700"
                    >
                      <input
                        type="checkbox"
                        name="subjects"
