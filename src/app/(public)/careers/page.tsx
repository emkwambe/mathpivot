      ...
      <section id="apply" className="py-16 px-4 bg-blue-50">
        <div className="max-w-xl mx-auto text-center">
          ...
          <p className="text-slate-600 mb-8 text-sm">
            Tell us about yourself. We review applications personally and reply
            within about a week.
          </p>
          <Link
            href="/coach-apply"
            className="inline-flex items-center justify-center bg-blue-600 text-white font-semibold px-8 py-3.5 rounded-xl text-base hover:bg-blue-700 transition-colors"
          >
            Start your application
          </Link>
          <p className="text-[11px] text-slate-500 mt-4">
            Five minutes to fill out. Background check required before
            onboarding.
          </p>
        </div>
      </section>
